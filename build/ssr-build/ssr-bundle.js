...
var WsClient = function WsClient() {
  var _useWs = Object(_hooks_useWs__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(),
    ws = _useWs.ws,
    wsUrl = _useWs.wsUrl,
    setWsUrl = _useWs.setWsUrl,
    history = _useWs.history,
    myChannels = _useWs.myChannels,
    availableChannels = _useWs.availableChannels,
    id = _useWs.id,
    wsState = _useWs.wsState,
    joinChannel = _useWs.joinChannel,
    getChannels = _useWs.getChannels,
    heartbeat = _useWs.heartbeat,
    broadcastMessage = _useWs.broadcastMessage,
    sendMessageToTargetChannel = _useWs.sendMessageToTargetChannel,
    sendMessageToJoinedChannels = _useWs.sendMessageToJoinedChannels;
  ...
  var bloopChannel = Object(preact_hooks__WEBPACK_IMPORTED_MODULE_0__[/* useCallback */ "a"])(function (e) {
    e.preventDefault();
    sendMessageToTargetChannel(JSON.stringify({
      type: 'bloop',
      channel: e.target.channel.value
    }));
  }, [sendMessageToTargetChannel]);
  var bloopChannels = Object(preact_hooks__WEBPACK_IMPORTED_MODULE_0__[/* useCallback */ "a"])(function () {
    return sendMessageToJoinedChannels(JSON.stringify({
      type: 'bloop'
    }));
  }, [sendMessageToJoinedChannels]);
  var broadcastBloop = Object(preact_hooks__WEBPACK_IMPORTED_MODULE_0__[/* useCallback */ "a"])(function () {
    return broadcastMessage(JSON.stringify({
      type: 'bloop'
    }));
  }, [broadcastMessage]);
  ...
  return h("div", null, h("div", null, "state: ", wsState), h("form", {
    ...
    type: "submit"
  }, "go")), ws && h(Fragment, null, wsUrl && h("div", null, "connected to: ", wsUrl), id && h("div", null, "id: ", id), heartbeat && h("div", null, "heartbeat: ", JSON.stringify(heartbeat)), h("form", {
    ...
    type: "submit"
  }, "join channel")), h("div", null, "my channels: ", JSON.stringify(myChannels)), h("div", null, "available channels: ", JSON.stringify(availableChannels)), h("form", {
    onSubmit: bloopChannel
  }, h("input", {
    type: "text",
    name: "channel"
  }), h("button", {
    type: "submit"
  }, "bloop channel")), h("button", {
    onClick: getChannels
  }, "get channels"), h("button", {
    onClick: bloopChannels
  }, "bloop my channels"), h("button", {
    onClick: broadcastBloop
  }, "broadcast bloop"), h("div", null, h("div", null, h("div", null, h("label", {
    htmlFor: "message"
  }, "message"), h("textarea", {
    cols: 100,
    rows: 1,
...
var just_range = __webpack_require__("BPfx");
...
var lodash_difference = __webpack_require__("fWLt");
...
var WsMonitor = function WsMonitor(_ref) {
  ...
  }, h("div", null, wsState), ws && wsUrl && h("div", null, "connected to: ", wsUrl), h("form", {
    onSubmit: handleWsUrlChange
  }, h("input", {
    type: "text",
    name: "wsUrl",
...
var useWs = function useWs() {
  ...
  Object(preact_hooks__WEBPACK_IMPORTED_MODULE_0__[/* useEffect */ "d"])(function () {
    ...
    var port = window.location.protocol.includes('https') ? '' : ':8081';
...
/* harmony import */ var react_piano__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("Qvep");
/* harmony import */ var react_piano_dist_styles_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("l2px");
